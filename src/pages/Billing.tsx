...
export default function Billing() {
  ...
  const handleCheckout = () => {
    if (selectedPlan === 'monthly') {
      // ATUALIZADO: Link sem o trial do MP para liberar o PIX
      window.location.href = "https://www.mercadopago.com.br/subscriptions/checkout?preapproval_plan_id=dd9ad3fa59e84c2d99c10c705f89a611";
    } else {
